...
const CustomTooltip = ({ active, payload }) => {
  if (active && payload && payload.length) {
    return (
      <div className=" w-[96%] md:w-[90%] max-w-[1600px] mx-auto p-2  shadow-md rounded-lg text-gray-800 text-sm border border-gray-100">
        <p>{payload[0].name}</p>
        {payload.map((item, i) => (
...
export default function DashboardWidgets() {
  ...
  return (
    <div className="grid grid-cols-1  w-[96%] md:w-[90%] max-w-[1600px] mx-auto lg:grid-cols-3 gap-6 p-2 bg-gradient-to-br  h-full">
      {/* Earnings Widget */}
      <motion.div
